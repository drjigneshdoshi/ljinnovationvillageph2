...
var app = angular
	...
	.config(function ($routeProvider) {
		$routeProvider
			...
			.when("/Branch", {
				templateUrl: "Templates/ManageBranches.html",
				controller: "loginController"
			})

			.when("/Challenges", {
				templateUrl: "Templates/ViewProblems.html",
				controller: "viewProblemsController"
			})
			...
			.when("/displayProjects", {
				templateUrl: "Templates/Homeprojects.html",
			...
			.when("/Admin/Institutes", {
				templateUrl: "Templates/Admin/ManageInstitutes.html",
				controller: "manageInstitutesController"
			})
			.when("/Admin/AddInstitute", {
				templateUrl: "Templates/Admin/AddInstitute.html",
				controller: "addInstituteController"
			})
			.when("/Admin/EditInstitute/:page", {
				templateUrl: "Templates/Admin/EditInstitute.html",
				controller: "adminEditInstituteController"
			})
			...
			.when("/Mentor/ReviewProjects", {
				templateUrl: "Templates/Mentor/ProjectReview.html",
				controller: "mentorReviewProjectsController"
			})
			...
			.when("/Student/Home", {
				templateUrl: "Templates/Student/ManageProject.html",
				controller: "studentProjectController"
			})
			.when("/Student/AddProject", {
				templateUrl: "Templates/Student/Project.html",
				controller: "studentProjectController"
			})
			...
			.when("/Student/ViewProject/:page", {
				templateUrl: "Templates/Student/ViewProject.html",
				controller: "studentEditProjectController"
			})
	...
	.controller("manageInstitutesController", function ($scope, $rootScope, authenticationService,httpService,myCookieService,$rootScope,$location) {
		authenticationService.authAtAdminRoute();
		$rootScope.changeLink();
		$scope.cookie = myCookieService.getCookie();
		$scope.show_masters_page = function(i){
	...
	.controller("adminEditInstituteController", function ($scope, $rootScope, authenticationService, httpService, myCookieService,$location) {
		$scope.inst_id = $location.url().split('/')[3];
		authenticationService.authAtAdminRoute();
		$rootScope.changeLink();
		$scope.cookie = myCookieService.getCookie();
		console.log($scope.cookie);
		...
		httpService.sendRequest(
			"GET",
			function (response) {
				$scope.institute = response.data.data
			},
			function (reason) {
				toastr.error("Error! " + reason.status + ": " + reason.statusText);
			},
		...
		$("form#editInstitute").submit(function (event) {
			//disable the default form submission
			event.preventDefault();
			//grab all form data  
			var formData = new FormData($(this)[0]);
			...
			$.ajax({
					...
					success: function (response) {
						...
						if (res.success == true) {
							toastr.success("Date Modified Successful! ");
							$location.path("/Admin/Institutes");
							$("form#editInstitute").trigger("reset");
						} else
							toastr.error("Error :" + res.error_message);
					},
					error: function (reason) {
	...
	.controller("addInstituteController", function ($scope, $rootScope, authenticationService,myCookieService,httpService,$rootScope,$location) {
		authenticationService.authAtAdminRoute();
		$rootScope.changeLink();
		$scope.cookie = myCookieService.getCookie();
		$scope.cookie = myCookieService.getCookie();
		$("form#registerInstitute").submit(function (event) {
			//disable the default form submission
			event.preventDefault();
			//grab all form data  
			var formData = new FormData($(this)[0]);
			...
			$.ajax({
					...
					success: function (response) {
						...
						if (res.success == true) {
							toastr.success("Registration Successful! ");
							$location.path("/Admin/AddInstitute");
							$("form#registerInstitute").trigger("reset");
						} else
							toastr.error("Error :" + res.error_message);
					},
					error: function (reason) {
	...
	//
		.controller("displayProjectController", function ($scope, $rootScope, authenticationService, httpService, myCookieService) {
		authenticationService.authAtHomeRoute();
		$rootScope.changeLink();
		$scope.cookie = myCookieService.getCookie();
		...
		params = {
			//"credentials": $scope.cookie.credentials,
			//"email": $scope.cookie.email,
			"get_lastyr_project_details": true
		};
	...
	.controller("reportsController", function ($scope, $rootScope, authenticationService, httpService, myCookieService) {
		...
		params = {
			"get_project_year_data": true
		};
		httpService.sendRequest(
			"GET",
			function (response) {
				$scope.projectyear = response.data;
			},
			function (reason) {
				toastr.error("Error! " + reason.status + ": " + reason.statusText);
			},
	...
	.controller("mentorEPController", function ($scope, $rootScope, authenticationService, httpService, myCookieService) {
		...
		$scope.problem_toggle = function(id){
			params = {
				"problem_id":id,
				"email":$scope.cookie.email,
				"credentials":$scope.cookie.credentials,
				"problem_selection_toggle": true
			};
			httpService.sendRequest(
				"GET",
				function (response) {
	...
	.controller("viewProblemsController", function ($scope, $rootScope, authenticationService, httpService, myCookieService) {
		authenticationService.authAtHomeRoute();
		$rootScope.changeLink();
		$scope.cookie = myCookieService.getCookie();
	...
	.controller("mentorReviewProjectsController", function ($scope, $rootScope, authenticationService, httpService, myCookieService) {
		authenticationService.authAtMentorRoute();
		$rootScope.changeLink();
		$scope.cookie = myCookieService.getCookie();
				params = {
		...
		params = {
			"credentials": $scope.cookie.credentials,
			"email": $scope.cookie.email,
			"get_registeredprojects_mentor": true
		};
		var update_projects = function(){
			httpService.sendRequest(
				"GET",
		...
		$scope.mentor_selected_toggle = function(id){
			params = {
				"project_id":id,
				"email":$scope.cookie.email,
				"credentials":$scope.cookie.credentials,
				"mentor_selection_toggle": true
			};
			httpService.sendRequest(
				"GET",
				function (response) {
		...
		$("form#rejectProject").submit(function (event) {
			if(confirm("Are you sure you want to submit ratings?")){
				//disable the default form submission
				event.preventDefault();
				//grab all form data  
	...
	.controller("studentProjectController", function ($scope, $rootScope, authenticationService, myCookieService, httpService, $location) {
		...
		var params = {
			"email": $scope.cookie.email,
			"get_proj_prob_stream_branch_data": true
		};
		httpService.sendRequest(
			"GET",
			function (response) {
	...
	.controller("studentEditProjectController", function ($scope, $rootScope, authenticationService, myCookieService, httpService, $location) {
		...
		authenticationService.authAtStudentRoute();
		$scope.project_id = $location.url().split('/')[3];
		$scope.cookie = myCookieService.getCookie();
		$scope.cookie = myCookieService.getCookie();
		var params = {
			"credentials": $scope.cookie.credentials,
		...
		httpService.sendRequest(
			...
			function (response) {
				if (response.data.success == true) {
					...
					$scope.project.team_member_emails = $scope.project.team_member_emails.split(',');
					$scope.project.team_member_contacts = $scope.project.team_member_contacts.split(',');
					...
					for(let i=0 ; i<$scope.project.team_members.length ; i++)
					{
						...
						let email_name = $scope.project.team_member_emails[i];
						let contact_name = $scope.project.team_member_contacts[i];		
						...
						$scope.project.team_members[i].email_name = email_name;
						$scope.project.team_members[i].contact_name = contact_name;
					//console.log($scope.project.team_members[i].contact_name);
					}
		...
		params = {
			"get_prob_stream_branch_data": true
		};
		httpService.sendRequest(
			"GET",
			function (response) {
