...
else if(($_FILES["photo"]["size"] == 0)) 
{
    ...
    $sql_temp = "INSERT INTO `user_master`(`email`, `contact`, `passwd`, `user_type`, `user_status`, `created_at`) VALUES ('$email',$contact,'$password','Student','1','$date')";
    $res_temp = mysqli_query($connect,$sql_temp);
    ...
    $sql_temp = "INSERT INTO `student_master`(`user_id`, `first_name`, `middle_name`, `last_name`, `gender`, `photo`) VALUES ($user_id,'$first_name','$middle_name','$last_name','$gender','$photo')";
    $res_temp = mysqli_query($connect,$sql_temp);
